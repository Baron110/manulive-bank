...
function Dashboard() {
    ...
    const profileData = {
        ...
        fullName: 'BARON QUIN',
        username: 'BARONISHIM',
        email: 'Baronquin300@gmail.com',
        pin: '1960',
        
        // Contact
        phone: '+44 20 7918 9612',
        
        // Location
        country: 'United Kingdom',
        state: 'London',
        city: 'London',
        fullAddress: '10 Downing Street, Westminster, London, SW1A 2AA, United Kingdom',
        
        // Date & Account
        dob: '19/02/2000',
        accountNumber: 'QC' + Math.floor(Math.random() * 10000000000),
    ...
    const generateTransactionHistory = () => {
        const history = [];
        const names = ['Sarah Jenkins', 'Acme Corp', 'Marcus Thorne', 'Netflix', 'Amazon', 'Starbucks', 'Whole Foods', 'Apple', 'Spotify', 'Uber', 'Rogers', 'Telus', 'BC Hydro', 'London City', 'Costco', 'Walmart', 'Tim Hortons', 'Lululemon', 'Arc\'teryx', 'MEC'];
    ...
    const handleSendMoney = () => {
        ...
        showMessage(
            '⛔ TRANSFER RESTRICTION: For your security, international transfers require additional verification. Please visit a QuinCore Bank branch or contact customer support at +44 20 7946 0123 to complete your verification process. We apologize for any inconvenience.',
            'warning'
        );
            ...
            <Container maxWidth="lg" sx={{ mt: 3, mb: 4 }}>
                ...
                {tabValue === 0 && (
                    <>
                        ...
                        {/* Virtual Card - Platinum Design */}
                        <Paper sx={{ p: 3, borderRadius: '20px', mb: 3, background: 'linear-gradient(135deg, #E5E4E2 0%, #C0C0C0 100%)', color: '#000000' }}>
                            <Typography variant="caption" sx={{ letterSpacing: 2, opacity: 0.7 }}>PLATINUM CREDIT CARD</Typography>
                            <Typography variant="h5" sx={{ fontFamily: 'monospace', letterSpacing: 2, mt: 2 }}>**** **** **** 1960</Typography>
                            <Box sx={{ display: 'flex', justifyContent: 'space-between', mt: 2 }}>
                                <Box><Typography variant="caption">Cardholder</Typography><Typography>BARON QUIN</Typography></Box>
                                <Box><Typography variant="caption">Expires</Typography><Typography>12/27</Typography></Box>
                                <Box><Typography variant="caption">CVV</Typography><Typography>***</Typography></Box>
                            </Box>
                            <Box sx={{ mt: 2, pt: 2, borderTop: '1px solid rgba(0,0,0,0.1)' }}>
                                <Typography variant="caption">Credit Limit</Typography>
                                <Typography>{formatCurrency(50000)}</Typography>
                            </Box>
                        </Paper>
                            ...
                            <Paper sx={{ p: 3, borderRadius: '20px' }}>
                                ...
                                <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
                                    ...
                                    <Box>
                                        ...
                                        <LinearProgress variant="determinate" value={74.5} sx={{ mt: 1, height: 8, borderRadius: 4 }} />
                                    </Box>
                                    <Box>
                ...
                {/* PROFILE TAB - YOUR HARDCODED INFO */}
                {tabValue === 3 && (
                    <Grid container spacing={3}>
                        <Grid item xs={12} md={4}>
                            <ProfileCard>
                                <Box sx={{ textAlign: 'center', mb: 3 }}>
                                    ...
                                    <Chip label={profileData.accountType} sx={{ mt: 1, bgcolor: '#D4AF37', color: '#000' }} />
                                </Box>
                                <Divider sx={{ my: 2 }} />
                                <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
                                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                            ...
                            <ProfileCard>
                                ...
                                <Grid container spacing={3}>
                                    ...
                                    <Grid item xs={6}>
                                        ...
                                        <Typography variant="h6">{profileData.accountType}</Typography>
                                    </Grid>
                                </Grid>
                        ...
                        {transferStep === 0 && (
                            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
                                ...
                                <FormControl fullWidth>
                                    ...
                                    >
                                        <MenuItem value="interac">Faster Payments (UK)</MenuItem>
                        ...
                        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2, mb: 3 }}>
                            <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                                ...
                                <Box>
                                    ...
                                    <Typography>{profileData.surname} {profileData.lastName}</Typography>
                                </Box>
                            </Box>
                            <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                                <Email sx={{ color: '#666' }} />
